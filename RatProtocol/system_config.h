...
//solenoids
#define SCENT_SOLENOID_A_LEFT_OUT     2
#define SCENT_SOLENOID_A_RIGHT_OUT    3

#define SCENT_SOLENOID_B_LEFT_OUT     4
#define SCENT_SOLENOID_B_RIGHT_OUT    5

#define SCENT_SOLENOID_C_LEFT_OUT  6
#define SCENT_SOLENOID_C_RIGHT_OUT  7 

#define SCENT_SOLENOID_D_LEFT_OUT  8
#define SCENT_SOLENOID_D_RIGHT_OUT  9
...
#define SCENT_SOLENOID_NONE_LEFT_OUT  1
#define SCENT_SOLENOID_NONE_RIGHT_OUT 1
